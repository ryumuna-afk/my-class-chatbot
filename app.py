...
# 2. 제미나이 AI 설정 (🚨 404 에러를 방지하는 가장 빠르고 안정적인 모델)
...
if user_question := st.chat_input("질문을 입력하세요!"):
    ...
    2. 정답을 찾았다면 숫자나 단어만 띡 출력하지 말고, 선택된 페르소나의 말투에 어울리는 '자연스러운 한두 문장'으로 대답하십시오. (예: "담임 선생님의 전화번호는 000-0000입니다.")
    3. 서론("네, 알려드릴게요", "안녕하세요" 등)이나 질문과 상관없는 엉뚱한 정보(TMI)는 절대 추가하지 마십시오.
