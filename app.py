...
# ==========================================
# 6. 💬 채팅 처리 (사서 AI 추론 능력 강화 + 대안 제시 프롬프트)
# ==========================================
if user_question := st.chat_input("질문을 입력하세요!"):
    ...
    3. 🌟대안 제시하기 (매우 중요)🌟: 만약 전달된 문서에 질문에 대한 답이 없다면, 절대 지어내지 마십시오!! 대신 반드시 "제가 가진 자료에는 그 내용이 없네요 ㅠㅠ 화면 위쪽에 있는 **'📁 2026학년도 학교안내자료 모음'** 단추를 눌러서 직접 확인해 보거나, 선생님께 직접 여쭤보는 건 어때?" 라고 친절하게 대답하십시오.
